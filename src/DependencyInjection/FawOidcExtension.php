...
class FawOidcExtension extends ConfigurableExtension
{
  public const BASE_ID                  = 'faw.oidc.';
  ...
  public function loadInternal(array $mergedConfig, ContainerBuilder $container): void
  {
    ...
    // Setup default alias
    $container
      ->setAlias(OidcClientInterface::class, sprintf('faw.oidc.client.%s', $mergedConfig['default_client']));
